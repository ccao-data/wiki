...
An appeal is effectively a second look at a value of a property produced by our office. The objective of this second look is to determine whether the value is accurate and fair. These SOPs are written to guide analysts to produce accurate and fair appeals decisions. 

Our motivation is fairness, transparency and ethics.

## Fairness

Illinois property taxes operate according to a levy-based system. In this system, local governments establish the amount of money they want to raise from property taxes, and the assessment process determines the distribution of that tax burden. During a re-assessment, assessors mail initial property values to taxpayers, who then have the opportunity to appeal the initial value based on inaccurate information. Successful appeals _do not deprive the government of tax revenue._ Instead, successful appeals shift the burden of a pre-determined levy from taxpayers with successful appeals to those without successful appeals, including those who do not appeal at all. Under this system, the appeals process has inherent consequences for fairness.
...
As a public trust, the CCAO should ensure a code of conduct in the appeals process where successful appeals do not shift the tax burden without just cause. Unethical behavior is most likely to occur when people are making consequential decisions in an untransparent environment with undefined rules. The linkage between the reason an appellant files a residential appeal, and the decision path an analyst uses to assign an appeal reason code are critical to the ethical behavior of the office. 
###  Code of conduct for low ball appraisals

Appraisals can be used as evidence for an appeal. The appraisal is an unbiased professional estimate of the fair cash value of a residence provided by a certified appraiser. In Cook County, collaborations between appraisers, and tax consultants and attorneys to increase the chances of a successful tax appeal.


### Appeals for vacancy and characteristics are vulnerable to schemes to defraud taxpayers

A resident should appeal their assessment to provide the CCAO with accurate information about the property to receive a fair cash value assessment. The impact of the current volume of appeals reveals a lack of public trust and incentive to lower fair and accurate property assessments. Two examples from the Chicago Tribune highlight a successful appeal based on pre-renovation [characteristics](https://www.chicagotribune.com/columns/eric-zorn/ct-column-todd-ricketts-property-tax-wilmette-zorn-20190910-onaglennijf6rjpv6ap6ajmdxy-story.html) where a century-old house was demolished and a new home was built on two properties. The other appeal was successful because it was [uninhabitable](https://www.chicagotribune.com/opinion/editorials/ct-edit-pritzker-toilet-fraud-blanchard-20181002-story.html) due to lack of facilities. Both reports diminish the CCAO as a public trust. Both reports diminish the CCAO as a public trust. 

###  Code of conduct for low-ball appraisals

An appraisal is an unbiased professional estimate of the fair cash value of a residence. When provided by a certified appraiser, appraisals can be used as evidence for an appeal.  In some cases, collaborations exists between appraisers, and tax consultants and attorneys to increase the chances of a successful tax appeal. To ensure these collaborations are working fairly for all taxpayers, the CCAO tax analysts and relevant staff can no longer work within rules where the rules are undefined and wrong. These SOPs will create accountability to those who only work to unfairly lower assessments.
...
In 2020, the Data Science Department conducted a qualitative analysis on the transparency of rules to appeal. The public-facing websites of 10 counties in the United States was surveyed for well-defined rules on the residential appeals process and the criteria to win an appeal. When applying industry best practices themes, there were three consistent findings. First, none of the counties have a published single source of truth for the appeals process and win criteria. Second, five out of ten counties provided criteria on how to win an appeal, however there are inconsistencies due to the number of webpages and sources. Third, all counties provided varying degrees of information on reasons and rules to appeal, however the readability of this information does not perform well according to the basic standards of words per sentence, jargon, and length of text. Based on these observations, there is no industry standard for transparency of the appeals process. The table below shows the qualitative analysis of the survey. For full details see [Residential Appeals County Survey Data](https://gitlab.com/ccao-data-science---modeling/documentation/wiki_content/-/issues/18).

| State | County | Reasons for Appeals | Rules to Appeal | Win Criteria | Filing Fee | In-person Hearing | Single Source of Truth|
|-------|---------|:-----------------:|:---------------:|:------------:|:----------:|:-----------------:|:---------------------:|
| Washington | King | 3 | 3| 2 | 0 | 0 | 0| 
| Arizona | Maricopa | 3 | 3 | 2 | 3 | 0 | 0|
| New York | New York | 3 | 3 | 3 | 3 | 2 | 0|
| Illinois | Lake | 3 | 3 | 3 | 1 | 0 | 0|
| Texas | Harris | 3 | 3 | 2 | 1 | 3 | 0|
| North Carolina | Wake | 3 | 3 | 2 | 0 | 0 | 0|
| Florida| Miami-Dade | 3 | 3 | 2 | 3 | 3 | 0|
| Florida | Broward | 3 | 3 | 2 | 3 | 3 | 0|
| California | Los Angeles | 3 | 3 | 3 | 0 | 3 | 0|
...
- **Third party filer trends:** The number of repeat flagged appeals filed by appraisers, tax consultants or tax attorneys.
...
- **Knowledge and retention of SOPs:** All residential tax analyst and relevant CCAO staff have access to centralized, simple and consist training for effective implementation.
...
**RAY & MARTY - guidelines can be driven by SmartFile**
...
******
> **Guideline A:** A reduction is warranted if the fair cash value of the subject property is greater than or equal to 1.1 times the median of its uniformity distribution.  

******
> **Guideline B:** A reduction is warranted if there are at least three virtually identical properties with fair cash values less than or equal to .95 times the subject property's fair cash value. 

******
> **Guideline BB:** A reduction is warranted if there are at least six similar properties with fair cash values less than or equal to .90 times the subject property's fair cash value. 

******
> **Guideline AA:** A reduction is **not** warranted if there are fewer than three comparable properties, either virtually identical or similar.

******
> **Guideline AB:** A reduction is **not** warranted if Guideline A is not met, and the taxpayer has not supplied a sufficient number of comparables to evaluate other guidelines.

******
> **Guideline AC:** A reduction is **not** warranted if Guideline A is not met, and the taxpayer has not supplied comparables that meet other guidelines.
...
******
> **Guideline O:** A reduction is warranted if the fair cash value of the subject property is greater than or equal to 1.15 times the median of its comparable sales distribution.  

******
> **Guideline OD:** A reduction is warranted if there are two **similar** property sale values less than or equal to .95 times the subject property's fair cash value, and one **own-property** sale value less than or equal to .95 times the subject property's fair cash value.

******
> **Guideline OD:** A reduction is warranted if there is one **virtually identical** property sale value less than or equal to .95 times the subject property's fair cash value, and one **own-property** sale value less than or equal to .95 times the subject property's fair cash value.

******
> **Guideline OA:** A reduction is warranted if there are at least three **virtually identical** property sale values less than or equal to .95 times the subject property's fair cash value. 

******
> **Guideline OB:** A reduction is warranted if there are at least six **similar** properties with sale prices less than or equal to .90 times the subject property's fair cash value.

******
> **Guideline OD:** A reduction is warranted if the appellant submits an appraisal with a total appraised value equal to or less than .90 times the  subject property's fair cash value.

******
> **Guideline OE:** **Managerial review** must be completed if the appellant submits an appraisal with a total appraised value equal to or less than .80 times the subject property's fair cash value.

******
> **Guideline OF:** A reduction is warranted if the appellant submits evidence of a loan or loans against the value of the property, where the debt holder is an institution, and the total value of the debt is equal to or greater than .85 times the fair cash value of the subject property.

******

> **Guideline OC:** A reduction is **not** warranted if there are fewer than three sales of comparable properties, either virtually identical or similar, and there are no **own-property** sales. 

> **Guideline OD:** A reduction is **not** warranted if Guideline A is not met, and the taxpayer has not supplied a sufficient number of comparable sales to evaluate other guidelines.
...
## Adoption
Public comment for the SOPs will remain open. Implementation of recommendations and changes will occur in iterations for the purpose of quality training during reassessment periods. 
