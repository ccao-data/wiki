...
Similarly, a very small reduction in value on appeal reflects a level of precision that is not credible. In 2018, 8\% of appeal reductions were between 2\% and 3\% of fair cash value, and **X\%** were below 5\%. The implication here is that the appeals analyst can detect even small deviations from true fair market values with the resources at their disposal. This is not credible based on the information presented above. 
