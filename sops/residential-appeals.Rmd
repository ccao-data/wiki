...
> **Guideline AD:** An appeal where uniformity is the indicated reason, but the comparable properties are consistent with an appeal based on a different reason, may be processed under the criteria for that reason.
...
A property sale can be used as a sale comparable if the sale date is within two years of the reassessment date, and if the characteristics of the property at the time of sale are identical to those at the reassessment date.
...
> **Guildline O:** A reduction is warranted if the fair cash value of the subject property is greater than or equal to 1.1 times the median of its comparable sales distribution.  

> **Guildline OD:** A reduction is warranted if there is one similar property with a sale price less than or equal to .95 times the subject property's fair cash value, and one same-property sale less than or equal to .95 times the subject property's fair cash value.

> **Guildline OA:** A reduction is warranted if there are at least three virtually identical properties with sale prices less than or equal to .95 times the subject property's fair cash value, where the sale dates all fall in the year prior to the assessment year. 

> **Guildline OB:** A reduction is warranted if there are at least six similar properties with sale prices less than or equal to .90 times the subject property's fair cash value, where the sale dates all fall in the year prior to the assessment year. 

> **Guildline OD:** 

> **Guildline OC:** A reduction is **not** warranted if there are fewer than three sales of comparable properties, either virtually identical or similar, where the sale dates all fall in the year prior to the assessment year.
