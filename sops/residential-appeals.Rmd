...
Unethical behavior is most likely to occur when people are making consequential decisions in an untransparent environment with little to no guidance and supervision. 
...
> **Guildline 2:** A reduction is warranted if the fair cash value of the subject property is greater than or equal to 1.1 times the median of its uniformity distribution.  
> **Guildline 3:** A reduction is warranted if there are at least three properties virtually identical to the subject property and within 1 mile of the subject property with fair cash values less than or equal to .95 times the subject property's fair cash value.
