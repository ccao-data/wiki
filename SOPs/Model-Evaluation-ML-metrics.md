...
- **c.** To validate your investigations from the balance tests, you can look at the standardized mean differences (between sample + population) for each feature.  (Larger differences = more likely deviation between sample and population).
